...
print("INSERT INTO [scFuncionario].[Funcionario] (nome, sobrenome, dt_nascimento, cpf, rg, sexo,\
 email, id_telefone, id_endereco, tipo_funcao, conta_deposito)\nVALUES")
...
for var_x in range(1000):
    ...
    var_tipo_funcao = randint(1, 11)
    var_conta_deposito = var_x + 3
    ...
    print(f"('{var_nome}', '{var_sobrenome}', '{var_dt_nascimento}', '{var_cpf}', '{var_rg}', '{var_sexo}', '{var_email}', '{var_id_telefone}', '{var_id_endereco}', '{var_tipo_funcao}', '{var_conta_deposito}'){var_sep}")
